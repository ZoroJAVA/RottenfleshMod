...
public class ItemExplosiveArrow extends ElementsRottenfleshMod.ModElement {
	@GameRegistry.ObjectHolder("rottenflesh:explosive_arrow")
	public static final Item block = null;
	public ItemExplosiveArrow(ElementsRottenfleshMod instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("rottenflesh:explosive_arrow", "inventory"));
	}
