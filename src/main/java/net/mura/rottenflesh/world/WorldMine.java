...
public class WorldMine extends ElementsRottenfleshMod.ModElement {
	...
	public static class BlockCustomPortal extends BlockPortal {
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.FIREWORKS_SPARK, px, py, pz, vx, vy, vz);
			}
		}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("plains")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("mushroom_island")), Biome.REGISTRY.getObject(new ResourceLocation("plains")),};
