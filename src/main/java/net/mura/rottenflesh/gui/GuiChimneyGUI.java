...
package net.mura.rottenflesh.gui;
...
public class GuiChimneyGUI extends ElementsRottenfleshMod.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiChimneyGUI(ElementsRottenfleshMod instance) {
		super(instance, 25);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 78, 58) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 115, 17) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				RottenfleshMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("rottenflesh:textures/chimney_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Chimney", 70, 3, -12829636);
		}
		...
		protected void actionPerformed(GuiButton button) {
			RottenfleshMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				ProcedureChimneyproc.executeProcedure($_dependencies);
			}
		}
