 ...
 *
 *    Keep the ElementsRottenfleshMod object in this class and all calls to this object
...
public class RottenfleshMod {
	...
	public ElementsRottenfleshMod elements = new ElementsRottenfleshMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsRottenfleshMod.GuiHandler());
